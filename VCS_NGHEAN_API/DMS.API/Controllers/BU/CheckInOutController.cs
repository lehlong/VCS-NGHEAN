...
namespace DMS.API.Controllers.MD
{
    ...
    public class CheckInOutController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblCheckInOutLiteDto checkInOut)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblCheckInOutLiteDto checkInOut)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblCheckInOutLiteDto checkInOut)
        {
            var transferObject = new TransferObject();
