...
namespace DMS.CORE.Migrations
{
    ...
    [Migration("20230705023416_update_fk_export_order")]
    partial class update_fk_export_order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuCheckInOutImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("tblBuCheckInOutImage");
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoOrder", b =>
                {
                    ...
                    b.HasIndex("ExportCode")
                        .IsUnique()
                        .HasFilter("[ExportCode] IS NOT NULL");

                    b.HasIndex("MixerCode");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoScale", b =>
                {
                    ...
                    b.HasIndex("OrderReleaseCode")
                        .IsUnique()
                        .HasFilter("[OrderReleaseCode] IS NOT NULL");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.BU.tblBuCheckInOutImage", b =>
                {
                    b.HasOne("DMS.CORE.Entities.BU.tblBuAttachment", "Attachment")
                        .WithOne("Image")
                        .HasForeignKey("DMS.CORE.Entities.BU.tblBuCheckInOutImage", "AttachmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DMS.CORE.Entities.BU.tblBuCheckInOut", "CheckInOut")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoOrder", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.SO.tblSoExport", "Export")
                        .WithOne("Orders")
                        .HasForeignKey("DMS.CORE.Entities.SO.tblSoOrder", "ExportCode");

                    b.HasOne("DMS.CORE.Entities.MD.tblMdMixer", "Mixer")
                        .WithMany("Orders")
                        .HasForeignKey("MixerCode");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.SO.tblSoScale", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.SO.tblSoOrderRelease", "OrderRelease")
                        .WithOne()
                        .HasForeignKey("DMS.CORE.Entities.SO.tblSoScale", "OrderReleaseCode");
